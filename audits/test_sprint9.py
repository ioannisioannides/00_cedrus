...
class NonconformityFormTests(TestCase):
    ...
    def setUp(self):
        ...
        self.auditor = User.objects.create_user(username="auditor_setup", password="testpass123")  # nosec B106
...
class NonconformityViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.auditor = User.objects.create_user(
            username="auditor1", password="testpass123", first_name="Test", last_name="Auditor"  # nosec B106
        )
        self.auditor_group = Group.objects.create(name="auditor")
        self.auditor.groups.add(self.auditor_group)

        self.client_user = User.objects.create_user(username="client1", password="testpass123")  # nosec B106
        self.client_group = Group.objects.create(name="client")
        self.client_user.groups.add(self.client_group)

        self.regular_user = User.objects.create_user(username="regular1", password="testpass123")  # nosec B106
    ...
    def test_auditor_can_add_nc(self):
        ...
        self.client.login(username="auditor1", password="testpass123")  # nosec B106
    ...
    def test_client_cannot_add_nc(self):
        ...
        self.client.login(username="client1", password="testpass123")  # nosec B106
        url = reverse("audits:nonconformity_create", kwargs={"audit_pk": self.audit.pk})
        response = self.client.get(url)
    ...
    def test_regular_user_cannot_add_nc(self):
        ...
        self.client.login(username="regular1", password="testpass123")  # nosec B106
        url = reverse("audits:nonconformity_create", kwargs={"audit_pk": self.audit.pk})
        response = self.client.get(url)
        self.assertEqual(response.status_code, 403)  # Forbidden
...
class ClientResponseTests(TestCase):
    ...
    def test_client_can_respond(self):
        ...
        self.client_http.login(username="client1", password="testpass123")  # nosec B106
