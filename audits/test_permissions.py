...
class PermissionPredicateTest(TestCase):
    ...
    def setUp(self):
        ...
        self.client_admin = User.objects.create_user(username="clientadmin", password="pass")
        self.client_admin.groups.add(self.client_admin_group)

        self.client_user = User.objects.create_user(username="clientuser", password="pass")
    ...
    def test_can_view_audit(self):
        ...
        other_auditor = User.objects.create_user(username="other", password="pass")
