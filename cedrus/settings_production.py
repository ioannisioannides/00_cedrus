...
# Note: Consider using django-csp package for more control
...
# =============================================================================
# CACHING (Optional - configure based on your infrastructure)
# =============================================================================

# Example: Redis Cache (requires django-redis)
# CACHES = {
#     'default': {
...
# Example: Memcached (requires python-memcached)
# CACHES = {
#     'default': {
