...
# Use environment variable in production, fall back to insecure key for development
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "django-insecure-t#d&9%_@)9kwm9xys0um_a7qihkd(^4g5%=dt5d8+ep2jcxs)y"  # nosec B105
)
