...
class Organization(models.Model):
    ...
    registered_id: models.CharField = models.CharField(
...
class Site(models.Model):
    ...
    site_scope_override: models.TextField = models.TextField(
...
class Standard(models.Model):
    ...
    ea_code: models.CharField = models.CharField(
...
class Certification(models.Model):
    ...
    certificate_id: models.CharField = models.CharField(
        max_length=100, blank=True, help_text="Certificate number/reference"
    )
    certificate_status: models.CharField = models.CharField(
...
class CertificateHistory(models.Model):
    ...
    certification: models.ForeignKey = models.ForeignKey(
...
class SurveillanceSchedule(models.Model):
    ...
    certification: models.OneToOneField = models.OneToOneField(
